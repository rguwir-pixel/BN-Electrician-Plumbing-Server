...
// यह कोड आपकी HTML और ऐप फाइल्स को लोड करेगा
...
app.get('/', (req, res) => {
    ...
    res.sendFile(filePath, (err) => {
        if (err) {
            res.send(`सर्वर बिल्कुल सही चल रहा है! लेकिन उसे आपकी फाइल नहीं मिली। सर्वर इस जगह पर फाइल ढूंढ रहा है: ${filePath} - कृपया चेक करें कि 'app' फोल्डर रेंडर पर अपलोड हुआ है या नहीं।`);
        }
    });
});
