...
// यह लाइन आपकी HTML, CSS, JS फाइलों को लोड करने की अनुमति देती है
// ध्यान दें: अब यह 'app' फोल्डर को सर्वर फोल्डर के अंदर ही ढूंढेगा
app.use(express.static(path.join(__dirname, "app")));

// यह रूट URL हैंडलर है
app.get('/', (req, res) => {
...
app.post('/api/subscriptions', auth, (req, res) => {
    ...
    if (![50, 100].includes(Number(plan))) {
        return res.status(400).json({ error: "Plan must be 50 or 100" });
    }
